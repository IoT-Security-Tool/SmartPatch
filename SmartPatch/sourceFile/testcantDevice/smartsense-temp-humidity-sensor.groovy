...
def refresh() {
	...
	if (manufacturer == "Heiman"|| manufacturer == "HEIMAN") {
		...
		return zigbee.readAttribute(0xFC45, 0x0000, ["mfgCode": 0x104E]) +   
		        zigbee.readAttribute(0xFC45, 0x0000, ["mfgCode": 0xC2DF]) +   
...
def configure() {
	...
	if (manufacturer == "Heiman"|| manufacturer == "HEIMAN") {
		...
		return refresh() +
		        zigbee.configureReporting(0xFC45, 0x0000, DataType.UINT16, 30, 3600, 100, ["mfgCode": 0x104E]) +   
		        zigbee.configureReporting(0xFC45, 0x0000, DataType.UINT16, 30, 3600, 100, ["mfgCode": 0xC2DF]) +   
