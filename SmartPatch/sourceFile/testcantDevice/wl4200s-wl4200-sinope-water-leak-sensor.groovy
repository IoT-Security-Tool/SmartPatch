...
def configure() {
    ...
    cmds += zigbee.configureReporting(0x0001, 0x0021, 0x20, 30, 43200, 1)		
    cmds += zigbee.configureReporting(0x0402, 0x0000, 0x29, 30, 3600, 300)		
    cmds += zigbee.configureReporting(0x0001, 0x003E, 0x1b, 30, 3600, 1)		
